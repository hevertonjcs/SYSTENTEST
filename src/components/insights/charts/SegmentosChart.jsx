...
const SegmentosChart = ({ data }) => {
  return (
    <Card className="bg-card border-border shadow-md">
      <CardHeader><CardTitle className="text-card-foreground text-base md:text-lg flex items-center gap-2"><Tag size={18} className="text-primary"/>Cadastros por Segmento</CardTitle></CardHeader>
