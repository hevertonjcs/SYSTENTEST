...
const SegmentosBarChart = ({ data }) => {
  if (!data || data.length === 0) {
    return <p className="text-muted-foreground text-center py-4">Sem dados de segmentos para exibir.</p>;
  }
  return (
    <Card className="bg-card border-border shadow-md">
      <CardHeader><CardTitle className="text-card-foreground text-base md:text-lg flex items-center gap-2"><Tag size={18}/>Cadastros por Segmento</CardTitle></CardHeader>
      <CardContent>
...
export default SegmentosBarChart;